...
tips.pivot_table(values=['total_bill', 'tip'], index='sex', columns='day', aggfunc='mean')
...
tips.pivot_table(values='total_bill', index='time', columns='day', aggfunc='mean').plot(kind='bar', cmap='viridis', alpha=0.5)
